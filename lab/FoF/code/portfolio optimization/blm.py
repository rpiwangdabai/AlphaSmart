...
data = pd.read_csv('/Users/Roy/Documents/Investment/Investment/FoF/Strategy-one/selcted_fund.csv')
...
P = pd.read_csv('/Users/Roy/Documents/Investment/Investment/FoF/Strategy-one/view.csv',header = None)
P = np.array(P.values)
