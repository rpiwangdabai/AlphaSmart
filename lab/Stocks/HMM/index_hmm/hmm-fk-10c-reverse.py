...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 14:21:54 2020
...
def rolling_compare(target_score, history_sequences,model):
    ...
    for value in top_10:
        possible_value.append(history_sequences[value - 1][0])
...
training_rolling_data = data['2019-01-01' : '2016-01-01'].values
...
train_for_predict_dataset = np.r_[test_rolling_data,training_rolling_data[100:]]
...
for i in range(1,len(test_rolling_data) + 1):
